...
1. An effect of day of year ($DOY$) and $DOY^2$ is included to account for within year differences in expected weight for a given length.  
1. NOTE-year is treated as a factor rather than continuous.
1. Predicted weights and 95% confidence intervals were generated for 800 to 1400 mm fish by incriments of 200. Estiamtes were
made for for each year and basin for $DOY$ = 92 (i.e., April 1)
...
1. The effect of DOY is not quite what I want, it might make more sense to use it to model variability in the $b$ parameter in a
hierarchical fashion. 
1. Any thoughts on what happened in the upper basin in 2011 and in early years  (2003, 2004)?  Those fish might have been skinny. Floods?   
